...
public class digitstowords {
    ...
    public static digitstowords getInstance() 
    {
        return digitstowordsHolder.INSTANCE;
    }

    private static class digitstowordsHolder 
    {

        private static final digitstowords INSTANCE = new digitstowords();
    }
    long num;

    private digitstowords() 
    {
        num = 0;
    }

    private digitstowords(long num) {
        this.num = num;
    }
    ...
    public static digitstowords getInstance(long num) 
    {
        return new digitstowords(num);
    }
