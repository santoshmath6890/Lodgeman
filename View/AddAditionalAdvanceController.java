 ...
 * @author RADHAKRISHNA
 */
public class AddAditionalAdvanceController implements Initializable {
    ...
    public void setApp(LodgeMan aThis) 
    {
        ...
        List<Receipts> allList = qm.findReceiptsTypeBetween(userlog.getStartdatetime(), currentDate, true);
       ...
       ColumnAction.setCellFactory(new Callback<TableColumn<Receipts, Boolean>, TableCell<Receipts, Boolean>>() 
        {
            ...
            {
                return new AddAditionalAdvanceController.AddBookingaddonCell(advancetable);
            }
        }
        );
    }
